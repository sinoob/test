...
public class WebCrawler {
	...
	static ArrayList<String> downloadedImages; // storing urls of downloaded
												// images
	static ArrayList<String> imageSearch; // storing urls of image search
											// results
	...
	public static void main(String[] args) throws Exception {
		...
		if (ch.equals("y") || ch.equals("yes")) {
			...
			if (ch.equals("g") || ch.equals("google")) {
				GoogleSearch();
			} else if (ch.equals("b") || ch.equals("bing")) {
				BingSearch();
			} else if (ch.equals("ya") || ch.equals("yahoo")) {
				GoogleSearch();
				// YahooSearch() ;
			} else if (ch.equals("i") || ch.equals("gi") || ch.equals("images") || ch.equals("googleimages")) {
				GoogleSearch();
	...
	/*
	 * public static void ImageSearch() throws IOException { googleImagesSearch
	 * gis = new googleImagesSearch() ;
	 * 
	 * imageSearch = new ArrayList<>() ;
	 * 
	 * try { imageSearch = gis.search() ;
	 * 
	 * 
	...
	public static void downloadImage(String url) throws Exception // download
																	// images.
	{
